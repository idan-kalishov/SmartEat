    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.dietaryRestrictions = DietaryRestrictions.decode(
            reader,
            reader.uint32(),
          );
          continue;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.micronutrients = Micronutrients.decode(
            reader,
            reader.uint32(),
          );
          continue;
...
export const CompleteMealAnalysisResponse: MessageFns<CompleteMealAnalysisResponse> =
  {
    encode(
      ...
      if (message.dailyRecommendations !== undefined) {
        NutrientRecommendation.encode(
          message.dailyRecommendations,
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 4: {
            ...
            message.dailyRecommendations = NutrientRecommendation.decode(
              reader,
              reader.uint32(),
            );
            continue;
...
export function NutritionsRatingServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcMethods) {
      ...
      GrpcMethod('NutritionsRatingService', method)(
    ...
    for (const method of grpcStreamMethods) {
      ...
      GrpcStreamMethod('NutritionsRatingService', method)(
        constructor.prototype[method],
        method,
        descriptor,
      );
...
export type NutritionsRatingServiceService =
  typeof NutritionsRatingServiceService;
export const NutritionsRatingServiceService = {
  analyzeMeal: {
    path: '/nutrition.NutritionsRatingService/AnalyzeMeal',
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: MealAnalysisRequest) =>
      Buffer.from(MealAnalysisRequest.encode(value).finish()),
    ...
    responseDeserialize: (value: Buffer) =>
      CompleteMealAnalysisResponse.decode(value),
  },
  getDailyRecommendations: {
    ...
    responseSerialize: (value: NutrientRecommendation) =>
      Buffer.from(NutrientRecommendation.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
