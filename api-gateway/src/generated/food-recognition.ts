    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.items.push(
            MealRecognitionResult.decode(reader, reader.uint32()),
          );
          continue;
        }
      }
...
export const IngredientDetailsResponse: MessageFns<IngredientDetailsResponse> =
  {
    encode(
      ...
      for (const v of message.items) {
        IngredientsRecognitionResult.encode(
          v!,
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.items.push(
              IngredientsRecognitionResult.decode(reader, reader.uint32()),
            );
            continue;
          }
        }
...
export const NutritionInfo: MessageFns<NutritionInfo> = {
  encode(
    ...
    Object.entries(message.per100g).forEach(([key, value]) => {
      NutritionInfo_Per100gEntry.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          const entry1 = NutritionInfo_Per100gEntry.decode(
            reader,
            reader.uint32(),
          );
...
export const NutritionInfo_Per100gEntry: MessageFns<NutritionInfo_Per100gEntry> =
  {
    encode(
      message: NutritionInfo_Per100gEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
      if (message.key !== '') {
...
export interface FoodRecognitionServiceController {
  analyzeMeal(
    ...
    | Observable<AnalyzeMealResponse>
    | AnalyzeMealResponse;
...
export function FoodRecognitionServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcMethods) {
      ...
      GrpcMethod('FoodRecognitionService', method)(
    ...
    for (const method of grpcStreamMethods) {
      ...
      GrpcStreamMethod('FoodRecognitionService', method)(
        constructor.prototype[method],
        method,
        descriptor,
      );
...
export type FoodRecognitionServiceService =
  typeof FoodRecognitionServiceService;
export const FoodRecognitionServiceService = {
  analyzeMeal: {
    path: '/foodrecognition.FoodRecognitionService/AnalyzeMeal',
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AnalyzeMealRequest) =>
      Buffer.from(AnalyzeMealRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => AnalyzeMealRequest.decode(value),
    responseSerialize: (value: AnalyzeMealResponse) =>
      Buffer.from(AnalyzeMealResponse.encode(value).finish()),
  ...
  fetchIngredientDetails: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: IngredientDetailsRequest) =>
      Buffer.from(IngredientDetailsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      IngredientDetailsRequest.decode(value),
    responseSerialize: (value: IngredientDetailsResponse) =>
      Buffer.from(IngredientDetailsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      IngredientDetailsResponse.decode(value),
  },
} as const;

export interface FoodRecognitionServiceServer
  extends UntypedServiceImplementation {
  analyzeMeal: handleUnaryCall<AnalyzeMealRequest, AnalyzeMealResponse>;
  fetchIngredientDetails: handleUnaryCall<
    IngredientDetailsRequest,
    IngredientDetailsResponse
  >;
}
