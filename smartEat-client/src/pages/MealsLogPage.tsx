...
import {
  Ingredient as ImageAnalyzeIngredient,
  NutritionData,
} from "@/types/imageAnalyizeTypes";
import { Ingredient as MealIngredient, Meal } from "@/types/meals/mealTypes";
...
const convertToImageAnalyzeIngredient = (
  ingredient: MealIngredient
): ImageAnalyzeIngredient => {
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        {(() => {
                          const convertedIngredients = meal.ingredients.map(
                            convertToImageAnalyzeIngredient
                          );
                          const nutrition =
                            calculateTotalNutrition(convertedIngredients);
                          return (
                            <>
