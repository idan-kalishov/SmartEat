...
import { Play, Pause, Square, Edit, ArrowRight, Droplets, Clock, Flame } from 'lucide-react';
...
const FastingTimer = () => {
    ...
    const [completedFasting, setCompletedFasting] = useState(savedData.completedFasting);
    ...
    useEffect(() => {
        saveData();
    }, [fastingState, startTime, selectedPlan, fastingHours, completedFasting, showPlanModal]);
    ...
    const getCurrentStage = () => {
        if (elapsed.hours < 3) return { stage: 0, name: 'תחילת הצום', icon: '⬆️' };
        if (elapsed.hours < 8) return { stage: 1, name: 'שריפת סוכר', icon: '⬇️' };
        if (elapsed.hours < 12) return { stage: 2, name: 'שריפת שומן', icon: '🔥' };
        return { stage: 3, name: 'קטוזיס', icon: '🧠' };
    };
    ...
    // פלאנים מוכנים מראש
    const presetPlans = [
        { name: '12', hours: 12, description: 'למתחילים' },
        { name: '14', hours: 14, description: 'קל ונוח' },
        { name: '16', hours: 16, description: 'פופולרי' },
        { name: '18', hours: 18, description: 'מתקדם' },
        { name: '20', hours: 20, description: 'אתגר' },
        { name: '24', hours: 24, description: 'יום מלא' }
    ];
            ...
            <div className="min-h-screen bg-gray-50 p-4">
                <div className="max-w-md mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="p-6 text-center">
                        ...
                        <div className="mb-8">
                            <h2 className="text-2xl font-bold text-green-600 mb-6">You did amazing!</h2>
                            ...
                            <div className="relative mb-8">
                                <div className="w-32 h-32 mx-auto mb-4 relative">
                                    ...
                                    <div className="absolute top-4 -right-4 text-green-500 font-bold text-lg">Nice!</div>
                                </div>
                            </div>

                            <p className="text-gray-600 mb-2">You have fasted for</p>
                            <p className="text-2xl font-bold text-gray-800">
                                {completedFasting.duration.hours} hours and {completedFasting.duration.minutes} minutes
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-8 text-sm">
                            <div>
                                ...
                                <p className="font-semibold">
                                    Today, {completedFasting.startTime.toLocaleTimeString('he-IL', {
                                    hour: '2-digit',
                                    minute: '2-digit'
                                })}
                                </p>
                            ...
                            <div>
                                ...
                                <p className="font-semibold">
                                    Today, {completedFasting.endTime.toLocaleTimeString('he-IL', {
                                    hour: '2-digit',
                                    minute: '2-digit'
                                })}
                                </p>
                        ...
                        <div className="mb-8">
                            <p className="text-gray-800 font-semibold mb-4">How did you feel during fasting?</p>
                ...
                {fastingState === 'active' ? 'Active Fast' : 'Upcoming Fast'}
                        ...
                        <div className="relative w-48 h-48 mx-auto mb-6">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                {fastingState === 'active' ? (
                                    ...
                                    <>
                                        <div className="text-3xl font-bold text-gray-800">{fastingHours} hours</div>
                    ...
                    {fastingState === 'active' && (
                        <div className="bg-green-50 rounded-xl p-4 mb-6">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="font-semibold text-green-800">{currentStage.name}</p>
                                    <p className="text-sm text-green-600">שלב {currentStage.stage + 1}</p>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-semibold text-gray-800">Stages of Body</h3>
                        </div>

                        <div className="grid grid-cols-4 gap-3">
                            {[
                                { icon: '⬆️', time: '0-3h', active: elapsed.hours < 3 },
                                { icon: '⬇️', time: '3-8h', active: elapsed.hours >= 3 && elapsed.hours < 8 },
                                { icon: '🔥', time: '8-12h', active: elapsed.hours >= 8 && elapsed.hours < 12 },
                                ...
                                >
                                    <div className={`text-2xl mb-2 ${
                                        fastingState === 'active' && stage.active ? 'animate-pulse' : ''
                                    }`}>
                                        {stage.icon}
                                    </div>
                    ...
                    <div className="bg-green-50 rounded-xl p-4">
                        <h3 className="text-lg font-semibold text-green-800 mb-3">During Fasting</h3>
                        <div className="flex items-start space-x-3 mb-3">
                            <div className="text-2xl">🥑</div>
                            <div className="flex-1">
                                <div className="flex items-center space-x-2 mb-2">
                                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                    <p className="text-sm text-gray-700">Stay hydrated by consuming water or herbal infusions.</p>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                    <p className="text-sm text-gray-700">Refrain from engaging in intense physical activities.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {showPlanModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-2xl max-w-sm w-full p-6">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-gray-800">Choose Fasting Plan</h2>
                            <button
                        ...
                        <div className="mt-6 p-4 bg-gray-50 rounded-xl">
                            ...
                            <div className="flex items-center space-x-3">
                                <input
                                    ...
                                    max="48"
                                    value={fastingHours}
                                    onChange={(e) => setFastingHours(parseInt(e.target.value) || 1)}
