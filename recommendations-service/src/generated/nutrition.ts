...
function createBaseNutrientRecommendation(): NutrientRecommendation {
  return { calories: 0, protein: 0, fats: 0, carbs: 0, fiber: 0, micronutrients: undefined };
}
...
export interface NutritionServiceClient {
  ...
  getAiRecommendations(request: AIRecommendRequest): Observable<AIRecommendResponse>;
}

export interface NutritionServiceController {
  getMealRating(request: MealAnalysisRequest): Promise<MealRating> | Observable<MealRating> | MealRating;

  getAiRecommendations(
    request: AIRecommendRequest,
  ): Promise<AIRecommendResponse> | Observable<AIRecommendResponse> | AIRecommendResponse;
}
...
export function NutritionServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcMethods) {
      ...
      GrpcMethod("NutritionService", method)(constructor.prototype[method], method, descriptor);
    }
    const grpcStreamMethods: string[] = [];
    for (const method of grpcStreamMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcStreamMethod("NutritionService", method)(constructor.prototype[method], method, descriptor);
    }
  };
}
...
export type NutritionServiceService = typeof NutritionServiceService;
export const NutritionServiceService = {
  getMealRating: {
    path: "/nutrition.NutritionService/GetMealRating",
    requestStream: false,
    ...
    responseSerialize: (value: MealRating) => Buffer.from(MealRating.encode(value).finish()),
    responseDeserialize: (value: Buffer) => MealRating.decode(value),
  },
  getAiRecommendations: {
    path: "/nutrition.NutritionService/GetAIRecommendations",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AIRecommendRequest) => Buffer.from(AIRecommendRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => AIRecommendRequest.decode(value),
    responseSerialize: (value: AIRecommendResponse) => Buffer.from(AIRecommendResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => AIRecommendResponse.decode(value),
  },
} as const;

export interface NutritionServiceServer extends UntypedServiceImplementation {
  getMealRating: handleUnaryCall<MealAnalysisRequest, MealRating>;
  getAiRecommendations: handleUnaryCall<AIRecommendRequest, AIRecommendResponse>;
}
